...
const translations = {
  fr: {
    ...
    question: "Question",
    score: "Score",
    quizCompleted: "Et voilà, c'est fini ! 🎉",
    quizPerfect: "Wow, 100% ! T'es un(e) pro ! 🏆",
    quizGood: "Pas mal du tout ! 👏",
    quizTryAgain: "Tu peux retenter ta chance si tu veux !",
    quizThanks: "Merci d'avoir joué ! On espère que tu as compris deux-trois trucs sur comment les IA de vision par ordinateur fonctionnent. C'est quand même dingue ce qu'on peut faire avec des maths et des pixels, non ? 🤖👁️",
    q1: "Comment l'ordinateur 'voit-il' ta main ?",
    q1_opt1: "Une simple photo",
    q1_opt2: "Un squelette de 21 points",
    q1_opt3: "Par magie",
    q2: "Que veut dire 'entraîner un modèle' ?",
    q2_opt1: "Lui apprendre à partir d'exemples annotés",
    q2_opt2: "Le faire tourner plus vite",
    q2_opt3: "Lui donner plus de mémoire",
  ...
  en: {
    ...
    question: "Question",
    score: "Score",
    quizCompleted: "And that's a wrap! 🎉",
    quizPerfect: "Wow, 100%! You're a pro! 🏆",
    quizGood: "Nice job! 👏",
    quizTryAgain: "Feel free to try again if you want!",
    quizThanks: "Thanks for playing! We hope you picked up a thing or two about how computer vision AI works. Pretty wild what you can do with math and pixels, right? 🤖👁️",
    q1: "How does the computer 'see' your hand?",
    q1_opt1: "A simple photo",
    q1_opt2: "A 21-point skeleton",
    q1_opt3: "By magic",
    q2: "What does 'training a model' mean?",
    q2_opt1: "Teaching it from annotated examples",
    q2_opt2: "Making it run faster",
    q2_opt3: "Giving it more memory",
