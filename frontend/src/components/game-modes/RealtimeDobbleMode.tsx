    ...
    return (
        <div className="min-h-screen relative flex flex-col p-6 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto flex gap-3 mb-6">
                ...
                <Button variant="ghost" onClick={() => navigateWithLang("/")} className="gap-2">
            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col lg:flex-row gap-6">
                <div className="flex-1 flex flex-col gap-6">
                    ...
                    <div className="game-card p-6 flex-1 min-h-[500px] relative overflow-hidden">
                        <div className="relative w-full h-full bg-muted rounded-lg overflow-hidden">
                            ...
                            {commonSymbol && (
                                <div className="absolute top-4 right-4 bg-primary/90 text-primary-foreground px-4 py-2 rounded-lg text-lg font-bold">
                                    {t("commonSymbol")}: {commonSymbol}
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <div className="w-full lg:w-80 space-y-4">
                    <div className="game-card p-6 space-y-4">
                        ...
                        {commonSymbol && (
                            <div className="p-4 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg text-center border">
